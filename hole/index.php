...
<head>
	...
	<link rel="stylesheet" href="/assets/css/hole.css">
...
-->
	<div id="wrapper">
		...
		<div id="header1">
			<h1 id="MainHeader">Яма - Google Диск, но с блэкджеком и шлюхами.
				<?php
				$f = './';
...
<!--
		<form id="formup" action="/download/.upload.php" method="post" enctype="multipart/form-data">
			Пополни яму:
			<input type="file" name="fileToUpload" id="fileToUpload">
			<input type="submit" value="Залить" name="submit">
		</form>
-->
<!--
		<ul class="sidenav">
			<li><a class="active" href="#home">Яма</a></li>
		</ul>
-->
		...
		<ul id="header" style="display: none !important;">
		...
		<ul>
			...
			<?php foreach ($items as $item): ?>
				...
				<li class="item" onclick="location.href='<?php echo htmlentities($itemURL) ?>';">
		...
		<?php if ($showFooter): ?>
			...
			<p id="footer">
				<a href="https://docs.google.com/document/d/1Pcv78uzFLaVobUJ3YCl2L04QK3BZcEeljoLQkiX583Y/edit?usp=sharing">Писать всё сюда</a>
			</p>
